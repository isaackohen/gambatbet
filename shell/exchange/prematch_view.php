    ...
    foreach ($bet_event_data['categories'] as $key => $category) {
	 ...
	 if($category['c_sort'] == '1'):?>
       <div class="cs modelwrap ms">
		...
		<div class="matvhrf xp">Matched: <span class="oftrack xp"><?php echo rand(10000,99000);?></span> <span class="laback xp top"><a id="bkall">Back All</a> <a id="lyall">Lay All</a></span></div>
       ...
       <span class="b_option_name xp"><div class="onamebg">.</div> <?php echo $option['bet_option_name'] ?>
		  ...
		  <span class="bbackk">
		    <?php echo $nbod;?></br><k style="font-size:10px;pointer-events:none"><?php echo $backrm - 9;?></k>
		   </span> 
		  ...
		  <span class="bback" id="cor-<?php echo $option['bet_option_id'];?>">
		   ...
		   <span class="blayy">
		    <?php echo $nlod;?></br><k style="font-size:10px;pointer-events:none"><?php echo $layrm - 9;?></k>
		   </span>
