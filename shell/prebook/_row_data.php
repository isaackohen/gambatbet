...
<div class="_row">
  ...
  <span class="livenow">
    <span></span>
			...
			<div class="tophg"><?= Lang::$word->UPCOMING_HIGHLIGHTS; ?></div> <div class="lignss"><span class="sp_sprit <?php echo $query['sname']; ?>">!</span><?php echo $query['event_name'];//substr($query['event_name'], 0, 20); ?></div>
