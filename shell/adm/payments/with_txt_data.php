...
$pid = $_POST['pid'];
$usid = $_POST['usid'];
$sql = "SELECT user_id, amount FROM sh_sf_withdraws WHERE id=$pid";
 $result = $conn->query($sql);
 while($row = $result->fetch_assoc()) {
  $user_id = $row['user_id'];
  $amount = $row['amount'];

  $ofyes = $conn -> query("UPDATE sh_sf_withdraws SET status = 'Processed' WHERE id=$pid");
