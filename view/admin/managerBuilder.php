...
?>
<div id="fm">
  <div class="yoyo top simple attached card">
    <div class="row horizontal-gutters align-middle">
      ...
      <div class="columns phone-100 content-center">
        ...
        <div id="displyType" class="yoyo buttons">
          <a data-type="table" class="yoyo simple icon button active"><i class="icon reorder"></i></a>
          <a data-type="list" class="yoyo simple icon button"><i class="icon unordered list"></i></a>
          <a data-type="grid" class="yoyo simple icon button"><i class="icon apps"></i></a>
        </div>
        <a id="fInsert" class="yoyo small secondary button hidden"><?php echo Lang::$word->INSERT;?></a>
      </div>
