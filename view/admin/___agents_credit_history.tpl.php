...
<div class="row half-gutters align-middle">
  <div class="column mobile-100">
      <h2>AGENTS CREDIT HISTORY</h2>
      This credit history is just for reference purpose. You may refer to see their credit patterns or if there is any abnormalities in the credit amount. This history is important for making assesement before withdrawals or transfers. Note* AID = Agent ID | AB = Amount Before | AMT = Amount won/loss | AA = Amount After | AUID = user_id of your affiliate
  </div>
...
Search Form</br>
<div class="searchsr">
      <input type="text" class="esearch" id="esearch" placeholder="Search by user ID or slip ID or Event Name..">
...
$("#ajax-content").empty().append("<div id='loading'><img src='<?php echo SITEURL;?>/shell/images/ajax-loader.gif' alt='Loading' /></div>");
      $.ajax({
			type: "POST",
		    url: "<?php echo SITEURL;?>/shell/adm/history/agent_records",
			data: {
			usid:vevent,	
			method:"singlehist"
			},
