...
<div class="row half-gutters align-middle">
  <div class="column mobile-100">
      <h2>DEPOSITS</h2>
      Deposits records both pending and history of all users. Pending or Processing are given as well in one count. The format of stats at top are given as: Total sum/No. of deposit rows. Eg. $300.00/3
  </div>
...
<div class="topingsg">
<h2>Deposits Summary [Amount/No. of Rows]</h2><hr>
...
$("#ajax-content").empty().append("<div id='loading'><img src='<?php echo SITEURL;?>/shell/images/ajax-loader.gif' alt='Loading' /></div>");
      $.ajax({
			type: "POST",
		    url: "<?php echo SITEURL;?>/shell/adm/payments/deposits",
			data: {
			usid:vevent,	
			method:"xpcreditrec"
			},
	...
	success: function(html) {
		...
		$.ajax({
			type: "POST",
		    url: "<?php echo SITEURL;?>/shell/adm/payments/txt_data",
			data: {
			usid:vevent,	
			method:"deposits_data"
			},
