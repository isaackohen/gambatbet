...
<div class="row horizontal-gutters align-bottom">
  <div class="columns">
    ...
    <a href="<?php echo Url::url(Router::$path, "new/");?>" class="yoyo secondary button"><i class="icon plus alt"></i><?php echo Lang::$word->_MOD_EM_SUB;?></a>
  </div>
...
<div class="yoyo card" id="item_<?php echo $row->id;?>">
  <div class="content">
    <p class="yoyo semi text">
      <a href="<?php echo Url::url(Router::$path . '/edit', $row->id);?>"><?php echo $row->title;?></a>
    </p>
    <p class="yoyo small text"><?php echo $row->venue;?></p>
    <div class="row align-middle">
      <div class="column">
        <div class="yoyo horizontal small list">
          <div class="item">
            <div class="header">
              <span class="yoyo caps light text"><?php echo Lang::$word->_MOD_EM_DATE_S;?></span>
              <span class="yoyo caps text"><?php echo Date::doDate("short_date", $row->date_start);?>
          ...
          <div class="item">
            <div class="header">
              ...
              <span class="yoyo caps text"><?php echo Date::doDate("short_date", $row->ending);?>
      ...
      <div class="column shrink">
        <a class="yoyo small positive icon button" href="<?php echo Url::url(Router::$path . '/edit', $row->id);?>"><i class="icon pencil"></i></a>
        <a data-set='{"option":[{"delete": "deleteEvent","title": "<?php echo Validator::sanitize($row->title, "chars");?>","id":<?php echo $row->id;?>}],"action":"delete","parent":"#item_<?php echo $row->id;?>","url":"modules_/events"}' class="yoyo small negative icon button action"><i class="icon trash"></i></a>
      </div>
    </div>
  </div>
</div>
