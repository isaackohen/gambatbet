...
?>
<h3 class="header"><?php echo Lang::$word->_MOD_FAQ_SUB1;?></h3>
<form method="post" id="yoyo_form" name="yoyo_form">
  ...
  <div class="content-center">
    ...
    <button type="button" data-url="modules_/faq" data-action="processCategory" name="dosubmit" class="yoyo primary button"><?php echo Lang::$word->_MOD_FAQ_SUB1;?></button>
  </div>
</form>
