...
?>
<h3 class="header">
  <?php echo Lang::$word->_MOD_GM_TITLE1;?>
</h3>
<form method="post" id="yoyo_form" name="yoyo_form">
  <div class="yoyo segment form">
    ...
    <div class="yoyo fields">
      <div class="field">
        ...
        <input data-ranger='{"step":1,"from":1, "to":20, "format":"level", "tip": false, "range":false}' type="hidden" name="zoom" value="<?php echo $this->data->zoom;?>" class="rangers">
      </div>
      <div class="field">
        <label><?php echo Lang::$word->_MOD_GM_SUB1_1;?></label>
        <input data-ranger='{"step":1,"from":1, "to":20, "format":"level", "tip": false, "range":true}' type="hidden" name="minmaxzoom" value="<?php echo $this->data->minmaxzoom;?>" class="rangers">
      </div>
    </div>
      ...
      <div class="field">
        ...
        <div class="scrollbox_right" style="height:180px;">
          <div class="row phone-block-1 mobile-block-2 tablet-block-3 screen-block-4 half-gutters content-center" id="pinMode">
            ...
            <div class="column">
              <a data-type="<?php echo $row;?>"><img src="<?php echo FMODULEURL;?>gmaps/view/images/pins/<?php echo $row;?>" alt="" class="yoyo basic image<?php echo ($this->data->pin == $row) ? " highlite" :'';?>"></a>
            </div>
            <?php endforeach;?>
            <?php unset($row);?>
          </div>
      ...
      <div class="yoyo fields">
        <div class="field">
          ...
          <div class="row phone-block-1 mobile-block-2 tablet-block-3 screen-block-4 gutters" id="layoutMode">
            ...
            <div class="column">
              <div class="yoyo basic attached segment<?php echo ($this->data->layout == pathinfo($row, PATHINFO_FILENAME)) ? " selected" :'';?>"><a data-type="<?php echo pathinfo($row, PATHINFO_FILENAME);?>"><img src="<?php echo AMODULEURL;?>gmaps/view/images/styles/<?php echo $row;?>" alt=""></a>
              </div>
            </div>
            <?php endforeach;?>
            <?php unset($row);?>
    ...
    <div class="yoyo fields">
      <div class="field">
        <div class="yoyo fluid action left icon input">
  ...
  <div class="content-center">
    <a href="<?php echo Url::url("/admin/modules", "gmaps/");?>" class="yoyo simple small button"><?php echo Lang::$word->CANCEL;?></a>
    <button type="button" data-url="modules_/gmaps" data-action="processMap" name="dosubmit" class="yoyo primary button"><?php echo Lang::$word->_MOD_GM_UPDATE;?></button>
  </div>
