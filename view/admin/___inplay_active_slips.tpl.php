...
$("#ajax-content").empty().append("<div id='loading'><img src='<?php echo SITEURL;?>/shell/images/ajax-loader.gif' alt='Loading' /></div>");
      $.ajax({
			type: "POST",
		    url: "<?php echo SITEURL;?>/shell/admin/in_active_set",
			data: {
	...
	//SHOW ON LOAD MORE SET
      $('body').on('click', ' .lodo', function(){
		...
		$(this).html('Loading...');
		$.ajax({
			url: "<?php echo SITEURL;?>/shell/admin/prematch_active_set",
			type: "post",
			data: {
				rc:rowCount,
				method:"prelodo"
 ...
 //SHOW LOAD MORE on single
      $('body').on('click', ' .lodosingle', function(){
		...
		$(this).html('Loading...');
		$.ajax({
			url: "<?php echo SITEURL;?>/shell/admin/in_active_single",
			type: "post",
			data: {
				rc:rowCount,
				lomo:lomo,
	...
	//Prematch win
      $('body').on('click', ' a.pwin', function(){
		...
		$.ajax({
			url: "<?php echo SITEURL;?>/shell/settlement/in_winning",
			type: "post",
			data: {
				afc:afc,
				id:winid,
	...
	//Prematch Lose
      $('body').on('click', ' a.plose', function(){
		...
		$.ajax({
			url: "<?php echo SITEURL;?>/shell/settlement/in_losing",
			type: "post",
			data: {
				afc:afc,
				id:winid,
	...
	//Prematch canceled
      $('body').on('click', ' a.pcan', function(){
		...
		$.ajax({
			url: "<?php echo SITEURL;?>/shell/settlement/in_canceled",
			type: "post",
			data: {
				afc:afc,
				id:winid,
	...
	//Prematch multibet canceled
      $('body').on('click', ' a.mcan', function(){
		...
		$.ajax({
			url: "<?php echo SITEURL;?>/shell/settlement/multi_canceled",
			type: "post",
			data: {
				afc:'inp',
				id:winid,
	...
	//search events
	 ...
	 /* if (es.length < 3){
	  ...
	  $.ajax({
			type: "POST",
		    url: "<?php echo SITEURL;?>/shell/admin/in_active_slips_search",
			data: {
			es:es,
			idt:idt,
			method:"esearch"
    ...
    $('body').on('click', ' .addfilter', function(){
	  $('#ajax-content').html("Loading.......");
	      ...
	      var dt2 = $('#my_date_picker2').val();
		   $.ajax({
			type: "POST",
		    url: "<?php echo SITEURL;?>/shell/admin/in_active_slips_datesearch",
			data: {
			dt1:dt1,
			dt2:dt2,
