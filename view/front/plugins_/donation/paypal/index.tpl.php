...
<div class="yoyo plugin segment<?php echo ($conf[0]->alt_class) ? ' ' . $conf[0]->alt_class : null;?>">
  ...
  <div class="yoyo fluid buttons">
    <div class="yoyo secondary passive button"><?php echo Utility::formatMoney($row->total);?></div>
    <div class="yoyo primary passive button"><?php echo Utility::formatMoney($row->target_amount);?></div>
  </div>
  <div class="content-center margin-top">
