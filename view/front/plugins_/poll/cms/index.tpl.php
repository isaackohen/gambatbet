...
<div class="yoyo basic plugin poll segment<?php echo ($conf[0]->alt_class) ? ' ' . $conf[0]->alt_class : null;?>">
  ...
  <div class="yoyo bold text half-bottom-padding content-center"><?php echo $rows->name;?></div>
  ...
  <div class="content-center half-top-padding goFront" style="display:<?php echo $voted == true ? 'none' : 'block';?>"> <a class="yoyo tiny primary button pollVote"><?php echo Lang::$word->_PLG_PL_VOTE;?></a> <a class="yoyo small bold text pollView"><?php echo Lang::$word->_PLG_PL_RESULT;?></a> </div>
  <?php endif;?>
</div>
<?php endif;?>