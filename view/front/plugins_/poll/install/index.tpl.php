...
<div class="yoyo poll plugin segment<?php echo ($conf[0]->alt_class) ? ' ' . $conf[0]->alt_class : null;?>">
  ...
  <?php endforeach;?>
  <div class="content-center half-top-padding hide-all goBack"> <a class="yoyo small semi text pollBack"><?php echo Lang::$word->BACK;?></a> </div>
  <div class="content-center half-top-padding goFront" style="display:<?php echo $voted == true ? 'none' : 'block';?>"> <a class="yoyo small primary button pollVote"><?php echo Lang::$word->_PLG_PL_VOTE;?></a> <a class="yoyo small semi secondary text pollView"><?php echo Lang::$word->_PLG_PL_RESULT;?></a> </div>
  <?php endif;?>
</div>
<?php endif;?>