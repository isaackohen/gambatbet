...
<main class="align-middle">
  <div class="column">
    ...
    <h1 class="yoyo primary text margin-top"><?php echo Lang::$word->META_ERROR;?></h1>
    ...
    <a href="<?php echo SITEURL;?>/" class="yoyo primary basic wide button"><i class="icon chevron left"></i>Go Back</a>
  </div>
</main>
-->
...
<style>
    ...
    * {
    ...
    .box .box__ghost .box__ghost-container .box__ghost-bottom div:nth-child(2n) {
        top: -12px;
        margin: 0 0px;
        border-top: 15px solid #eb1515;
        background: transparent;
    }
    .box .box__ghost .box__ghost-shadow {
        height: 20px;
        box-shadow: 0 50px 15px 5px #eb1515;
        border-radius: 50%;
        margin: 0 auto;
