...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <?= form_open_multipart('users/add_badge', 'id="badgeForm" class="form"'); ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?= lang('class', 'class'); ?>
                                <?= form_input('class', set_value('class'), 'class="form-control" id="class"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="modal-footer mm-footer">
            <div class="col-md-12">
                ...
                <img src="" id="img" style="max-width:32px;max-height:32px;float:left;" />
                <?= form_submit('add_badge', lang('add_badge'), 'class="btn btn-primary"'); ?>
            </div>
        </div>
        <?= form_close(); ?>
    </div>
