...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?= form_open("settings/add_field/", 'id="fieldForm" class="form"'); ?>
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            ?>
                            <?= form_dropdown('category', $cs, set_value('category', $category_id), 'class="form-control select2" id="category" style="width:100%;"'); ?>
                        </div>
                        <div class="type_con">
                            <div class="form-group">
                                <label><?= lang('type'); ?></label>
                                <?php $options = array('text' => lang('text'), 'select' => lang('select'), 'checkbox' => lang('checkbox'), 'radio' => lang('radio'), 'url' => lang('url')); ?>
                                <?= form_dropdown('type', $options, '', 'class="form-control cftype select2" style="width:100%;"'); ?>
                            </div>
                            <div class="form-group" id="select-con" style="display:none;">
                                <label><?= lang('options', 'cfoptions'); ?></label>
                                <?= form_input('options', '', 'class="form-control" id="cfoptions"'); ?>
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio" for="for_no">
                                <input type="radio" name="req_field" value="0" checked="checked" id="for_no"/>
                                <span class="icon"><i class="fa fa-circle"></i></span>
                                <?= lang('no') ?>
                            </label>
                            <label class="radio" for="for_yes">
                                <input type="radio" name="req_field" value="1" id="for_yes"/>
                                <span class="icon"><i class="fa fa-circle"></i></span>
                                <?= lang('yes') ?>
                            </label>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="radio" for="for_no1">
                                <input type="radio" name="public" value="0" checked="checked" id="for_no1"/>
                                <span class="icon"><i class="fa fa-circle"></i></span>
                                <?= lang('no') ?>
                            </label>
                            <label class="radio" for="for_yes1">
                                <input type="radio" name="public" value="1" id="for_yes1"/>
                                <span class="icon"><i class="fa fa-circle"></i></span>
                                <?= lang('yes') ?>
                            </label>
                        </div>
        ...
        <div class="modal-footer mm-footer">
            <div class="col-md-12">
                <?= form_submit('add_field', lang('add_field'), 'class="btn btn-primary"'); ?>
            </div>
        </div>
        <?= form_close(); ?>
    </div>
