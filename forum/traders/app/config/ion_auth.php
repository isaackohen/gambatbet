 ...
 */
$config['site_title']                 = "Simple Forum";     // Site Title, example.com This is not more functional
$config['admin_email']                = "noreply@forum.tecdiary.my"; // Admin Email, admin@example.com This is not more functional
